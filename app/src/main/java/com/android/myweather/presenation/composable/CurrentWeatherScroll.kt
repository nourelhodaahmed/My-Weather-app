...
fun CurrentWeatherScroll(){
    Box{
        CurrentWeatherIcon(
            parentModifier = Modifier.padding(top = 15.5.dp, bottom = 15.5.dp).size(150.dp),
        ...
        CurrentTemperatureInfo(
            modifier = Modifier.padding(top = 23.5.dp, start = 100.dp, bottom = 14.5.dp).align(Alignment.BottomCenter)
        )
    }
}
